...
Run `pip install -r requirements.txt` to install the necessary packages. You may want to use virtual environment, e.g.:
...
Additionally you will need [PyTorch](https://pytorch.org/get-started/locally/) (>=1.0.1).

GPU will make processing faster, but is not mandatory.
...
`python3 demo_toolbox.py -d <datasets_root>`  
or  
